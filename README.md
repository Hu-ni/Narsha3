...
기사
-패시브: 철제 갑옷: 물리 데미지를 10% 덜 받습니다.
-Q: 찌르기: 검으로 전방을 찔러 범위 안의 모든 적들에게 물리 데미지를 줍니다. 쿨타임 5초
-W: 전력질주: 8초 동안 이동속도가 n% 상승합니다. 쿨타임 12초
-E: 폼멜 타격: 다음 기본공격이 적을 1초 동안 기절시킵니다. 기본공격을 맞출 때 마다 쿨타임이 1초씩 줄어듭니다. 쿨타임 8초
-R: 굳은 의지: 10초 동안 모든 군중제어기의 효과가 반감되고 데미지가 15%, 공격속도가 30% 오릅니다. 쿨타임 40초
